...
6. Report changes or review findings, checks/results, milestone acceptance/status and remaining issues. Distinguish completing a local change from completing a milestone.
