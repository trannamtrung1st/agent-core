...
- `dotnet test tests/AgentCore.Application.Tests` — exit 0 (68 passed; 20-turn demo does **not** rewrite [m12-stage-latencies.md](m12-stage-latencies.md) unless `AGENTCORE_WRITE_STAGE_LATENCIES=1`)
