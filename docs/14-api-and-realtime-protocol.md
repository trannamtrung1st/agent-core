...
| POST /api/v2/admin/definition-drafts/{draftId}/validate | Owner capability; trusted local caller | 200 validation result (`draftRevision`, `hasBlockingFindings`, `findings[]`) | 401 capability; 403 non-local; 404 |
