...
| --- | --- | --- |
| 0 | Documentation/contracts finalized | Coherent specification; Markdown and small agent/tooling config |
...
| 3 | OpenAICompatibleLanguageModel + OpenRouter configuration | Offline SSE contracts; optional `openrouter/free` smoke skips without `OPENROUTER_API_KEY` |
