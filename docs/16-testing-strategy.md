...
Do not mark P1C-3 real non-English Browser STT/TTS smoke observed: it remains **BLOCKED** (no operator-attended Chrome/Edge + microphone + locale voices). P0-2 Chrome 153 `general-assistant` Voice checklist remains the last recorded real-browser Voice evidence (HEAD `215de23ecefe65560b0b7a666783122d6c67408c`); it was not re-run at P1-Final. Optional hosted multilingual checks were not run. P1 freeze is therefore blocked; P2 has not started.
