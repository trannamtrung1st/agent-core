...
**Follow-on P1 planned until verified:** Additive `lifecycleStatus` and purpose/deadline/policy persist on the snapshot; authoritative `TransitionLifecycle`, RequestComplete, and session speech-locale override remain unimplemented. See [Technology Decisions](10-technology-decisions.md#decision-bounded-history-and-durable-lastentrysequence).
