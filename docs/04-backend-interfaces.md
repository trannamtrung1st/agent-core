...
**Follow-on P1 planned until verified:** Speech locale/voice selection in Browser and hosted adapters is observed. Real Chrome 153 `fr-FR` Browser STT/TTS smoke is observed. See [Technology Decisions](10-technology-decisions.md#decision-provider-neutral-effective-speech-locale).
