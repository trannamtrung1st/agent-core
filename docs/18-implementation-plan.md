...
| P1-Final | Exact live `synthetic.yml` plus Compose; catalog/archive/pause regressions remain; P0 Chrome Voice checklist re-run | Deterministic gates green 2026-09-19 (Domain 40; Infra 112/9 skip; App 346 blame-hang; API 120; Vitest 324; Playwright 34; Compose `8e2467bf-7db9-4520-851a-146584761cb7`). Unedited Voice re-run pass: `p1-final-chrome-probe-run.log` on `df0a12c`. Unedited `fr-FR` smoke pass: `p1-final-fr-smoke-r2` on `5764010`. Optional hosted multilingual **unverified**. **P1 frozen**; P2 not started |
