...
OWN-WORLD: Ant Design v6 light operate UI. ChatGPT is a layout and hierarchy reference only—no ChatGPT assets, branding, or second kit. Product CSS is limited to rail width, header, column measure, bubbles, markdown, composer shell, chips, and breakpoints.
...
FIRST VIEWPORT: 280px rail at 1200px+ (240px from 768–1199px; Drawer below 768px) with Agent Core, New chat, Chats. Compact header with agent name and overflow. Centered ~800px conversation. Sticky composer: attach, field, voice, send. Empty new-chat: “What do you want to work on?” plus Identity Select and the same composer. Mobile empty header reads New chat; Profile: Synthetic stays visible.
